...
public class ResourceRuleFactory implements IResourceRuleFactory {
	...
	/**
	 * Default implementation of <code>IResourceRuleFactory#syncInfoRule</code>.
	 * This default implementation always returns <code>null</code>.
	 * <p>
	 * Subclasses may not currently override this method.
	 *
	 * @see org.eclipse.core.resources.IResourceRuleFactory#syncInfoRule(IResource)
	 */
	@Override
	public final ISchedulingRule syncInfoRule(IResource resource) {
		return null;
	}
