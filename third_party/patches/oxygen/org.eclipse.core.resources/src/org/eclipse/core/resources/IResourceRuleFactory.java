...
public interface IResourceRuleFactory {
	...
	/**
	 * Returns the scheduling rule that is required for maintaining sync
	 * info of a resource.
	 *
	 * @see ISynchronizer#setSyncInfo(QualifiedName, IResource, byte[])
	 * @param resource the resource related to the sync info
	 * @return a scheduling rule, or <code>null</code>
	 * @since 3.12.100
	 */
	public ISchedulingRule syncInfoRule(IResource resource);
