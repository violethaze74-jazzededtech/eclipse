...
public class AppEngineFlexWarProjectWizardTest {

  private AppEngineFlexWarProjectWizard wizard = new AppEngineFlexWarProjectWizard();

  @Test
  public void testWindowTitle() {
    Assert.assertEquals("New App Engine Flexible WAR Project", wizard.getWindowTitle());
  }
